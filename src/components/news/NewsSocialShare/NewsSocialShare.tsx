...
export default function NewsSocialShare({
    ...
    /*
     * WhatsApp:
     * Send only the article URL.
     *
     * WhatsApp will fetch the URL and use the Open Graph metadata
     * generated by the Vercel [slug].ts endpoint for:
     * - article image
     * - article title
     * - article summary
     * - thenewstime.in site information
     *
     * Do not append the title here because WhatsApp would display
     * the title and URL again below the generated link preview.
     */
    const whatsappUrl =
